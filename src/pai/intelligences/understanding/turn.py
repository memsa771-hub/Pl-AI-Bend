...
async def understand_turn(gateway, *, message: str, recent: list, profile: str,
                          candidates: list[str], timeout_seconds: float = 12) -> TurnUnderstanding:
    try:
            ...
            result = await gateway.run(task="turn_understanding", output_schema=TurnUnderstanding,
                ...
                messages=[
                    LLMMessage(role="system", content=(
                        ...
                        "helps the present decision. Understand ambiguity, negation, third-party attribution, "
        ...
        logger.warning("Turn understanding unavailable; using neutral counseling with evidence access")
