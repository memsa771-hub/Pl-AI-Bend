...
revision: str = "020_longitudinal_student_model"
down_revision: Union[str, None] = "019_document_sensitive_payloads"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None


def _backfill_education_levels() -> None:
    """Preserve existing qualification names without inventing equivalencies."""
    op.execute("UPDATE educations SET original_name = degree WHERE original_name IS NULL")
